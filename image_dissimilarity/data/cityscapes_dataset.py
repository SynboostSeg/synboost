...
class CityscapesDataset(Dataset):
    ...
    def __init__(self, dataroot, preprocess_mode, crop_size=512, aspect_ratio= 0.5, flip=False, normalize=False,
        ...
        dataroot = '/kaggle/input/synboostwo-data-generator/final_dataset/road_anomaly/original'
        self.original_paths = [os.path.join(dataroot, image)
                               for image in os.listdir(os.path.join(dataroot))]
        if light_data:
            dataroot = '/kaggle/input/road-anomaly-synthesis-spade-sdcnet/synboost/image_synthesis_spade/results/cityscapes_pretrained/test_latest/images/synthesized_image'
